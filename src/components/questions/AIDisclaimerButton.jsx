...
const DEFAULT_TITLE = 'Antes de importar estas preguntas';
...
export default function AIDisclaimerButton({
  title,
  children,
  buttonLabel = 'Aviso importante',
  variant = 'outline',
  size = 'default',
  className = '',
}) {
  ...
  return (
    <>
      <Button
        ...
        className={`gap-2 rounded-xl text-amber-600 border-amber-400/60 hover:bg-amber-50 dark:hover:bg-amber-950/30 ${className}`}
      >
